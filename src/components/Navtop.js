...
export default function Navtop() {
    ...
    <Navbar className="p-3 sticky-top" expand="lg" style={{ backgroundImage: '#F4F5F7' }}>
                ...
                <Navbar.Brand><NavLink to="/">LifeStyle App</NavLink></Navbar.Brand>
                    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                    <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav>

                    <NavLink className="mx-2" style={{color: '#E15047' , textDecoration:'none'}}  to="userprofiledisplay" >User Profile</NavLink>
